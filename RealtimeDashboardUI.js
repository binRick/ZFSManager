var ServersTableDriver = require('./ServersTableDriver'),
...
var grid2 = new contrib.grid({
    rows: 2,
    cols: 1
})
grid2.set(0, 0, 1, 1, contrib.gauge, {
...
grid3.set(0, 1, 1, 1, ServersTableDriver, {
    keys: true,
    fg: 'green',
    label: 'Select Server',
